          ...
          <div className="col-md col-lg">
            <div className="row g-3">
              ...
              <div className="col-sm-6">
                ...
                <input type="text" className="form-control" id="imagem" name="imagem" value={destino.imagem} onChange={handleInputChange} required />
              </div>

              <div className="col-sm-6">
                <label htmlFor="descricao" className="form-label">Descrição</label>
                <input type="text" className="form-control" id="descricao" name="descricao" value={destino.descricao} onChange={handleInputChange} required />
              </div>
...
export default CadastrarDestino;
