        ...
        <section className="container">
          <div className="container cadastro-cliente">
            <form className="needs-validation" noValidate="">
              ...
              <Link href="/" passHref>
                <a className="w-100 btn btn-primary btn-lg mb-2" type="button">
                  Logar
                </a>
              </Link>
              <Link href="#">Esqueceu a senha?</Link>
              <hr className="my-2" />
              <Link href="/add-client" passHref>
                <a className="w-100 btn btn-primary btn-lg btn-criar">
                  Cadastro
                </a>
              </Link>
            </form>
